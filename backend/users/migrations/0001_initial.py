# Generated by Django 4.2.17 on 2025-11-12 22:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='stats_history', to=settings.AUTH_USER_MODEL)),
            ],
            options={
